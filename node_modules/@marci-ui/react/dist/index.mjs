...
function Checkbox2(props) {
  return /* @__PURE__ */ jsx3(CheckboxContainer, __spreadProps(__spreadValues({}, props), { children: /* @__PURE__ */ jsxs3(CheckboxIndicator, { asChild: true, children: [
    /* @__PURE__ */ jsx3(Check, { weight: "bold" }),
    "0"
  ] }) }));
}
